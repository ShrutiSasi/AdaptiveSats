...
!["Bitcoin prices with halvings annotated"](images/halving.png){#halving fig-alt="Alt text"}

!["mvrv, sopr and nupl plots"](images/mvrv_sopr_nupl.png){#mvrv fig-alt="Alt text"}
