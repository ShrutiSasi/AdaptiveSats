...
One of the first strategies we used in the feature selection step was removing columns with zero variance. According to Max Kuhn and Kjell Johnson (2019), features with a single unique value (zero variance) provide no information gain. Therefore, removing them helps avoid numerical instability.
...
### Graph
  ...
  ![Cumulative metric coverage over time](figures/fig_cumulative_metric_coverage.png)
