...
The final allocation signal combined regime probabilities, valuation adjustments, volatility adjustments, and trend information into a single bounded portfolio weight. This adaptive framework enabled the strategy to systematically allocate more capital during historically attractive market conditions. See @tbl-strategy-comparison for the performance summary and @sec-appendix-hmm-garch for a more detailed explanation.
...
See @tbl-strategy-comparison for the detailed performance summary and @sec-appendix-hmm-bayes for a more detailed explanation.
...
-   **Blog post** and **Video** detailing the strategies developed.
    ...
    - Access Video:
        ...
        - [Composite Signal Index Strategye](https://youtu.be/5kC7x73eCyc?si=6O4H_G6Xm0t13b6U)
        - [Multi-Strategy Regime-Based Strategy](https://youtu.be/FSLVe98qfoU?si=pSCwki6ZndKubkxm)
        - [HMM-GARCH and BAYESIAN](https://youtu.be/znfH24iVRaM?si=lCpZjtOfOAcenL32)
