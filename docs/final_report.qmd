...
The External Tunable approach was developed to make the Bitcoin accumulation strategy aware of the broader global economy, rather than relying solely on Bitcoin-native data. A standard on-chain approach, such as using only the MVRV ratio, may struggle to adapt when global macroeconomic conditions abruptly change. Therefore, this method first evaluates external financial indicators—specifically U.S. Treasury Yields and price momentum—to identify 'Risk-On' and 'Risk-Off' market regimes. It then dynamically boosts or dampens a baseline MVRV signal to match the current macroeconomic environment.

After applying the optimized strategy to the 2024–2025 test period, the External Tunable approach successfully outperformed the Uniform DCA baseline across key evaluation metrics. See @tbl-strategy-comparison for a performance summary.
...
[HMM-GARCH Adaptive Strategy vs Uniform DCA]
...
| Exponential-Decay Percentile | 40.36% | 47.35% | 40.63% | 60.66% | 65.5% | 38.0% |
| Score | 52.46% | 60.05% | 58.46% | 80.33% | 82.76% | 19.0% |
| Avg SPD | 1346 \newline (+4.14%) | 1313 \newline (+1.60%) | 1297 \newline (+0.37%) | 1423 \newline (+10.13%) | 1346 \newline (+4.14%) | 1292 |
