...
date: "2026-06-19"
categories: [research, bitcoin, strategy, data-science, backtesting]
...
| `lth_nupl` | Long-Term Holder Net Unrealized P&L | Low = capitualation/undervaluation |
...
where $\mu_{t,365}$ and $\sigma_{t,365}$ are the mean and standard deviation computed over the trailing 365-day window ending at day $t$. A small constant $\varepsilon = 10^{-8}$ prevents division by zero. 
...
$$\qquad w_i = \frac{e^{\ell_i}}{\sum_j e^{\ell_j}}$$
