...
The strategy used a small set of raw Bitcoin market and on-chain features, then created engineered rolling features from them.

The main raw input features were:

* **price_usd**: Bitcoin price in USD
* **mvrv**: market value to realized value ratio
* **realized_cap_growth_rate**: growth rate of realized cap
* **market_cap_growth_rate**: growth rate of market cap

These features were chosen because each one captures a different part of the Bitcoin market. Price captures market movement. MVRV captures valuation relative to on-chain cost basis. Realized-cap growth and market-cap growth help compare whether on-chain value or market price value is leading.
