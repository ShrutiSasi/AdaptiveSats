...
This is useful for a Bitcoin accumulation strategy because the goal is to buy more sats per dollar. If Bitcoin is cheaper relative to its realized value, allocating more on those days may improve long-term accumulation compared with investing the same amount every day.
...
This strategy was included because it captures recent price behavior, which provides a different type of signal from valuation-based or moving-average-based strategies.
