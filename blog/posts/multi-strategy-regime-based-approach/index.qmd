...
date: "2026-06-16"
categories: [Research, Bitcoin, Strategy, Regime-Based, Backtesting]
format:
  html:
    toc: true
    toc-depth: 3
...
- Annual budget normalization is useful for a clean backtest, but it is not exactly the same as live deployment. In a live system, future days in the year are unknown, so allocation would need to be handled with a real-time budget pacing rule.
...
**_Are different Bitcoin accumulation signals useful in different market regimes?_**
