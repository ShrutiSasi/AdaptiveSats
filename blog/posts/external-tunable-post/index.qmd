...
For the **training period (2018–2023)**, the External Tunable approach achieved an SPD of **8,210.91**, compared with **8,418.79** for Uniform DCA, which corresponds a **2.47%** down.

For the **test period (2024–2025)**, the External Tunable approach achieved an SPD of **1,346.27**, compared with **1,292.12** for Uniform DCA, corresponding to an improvement of **4.19%**.
