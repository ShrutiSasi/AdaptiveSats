---
title: "External Tunable Approach for Bitcoin Accumulation"
...
date: "2026-06-18"
categories: [Research, Bitcoin, Strategy]
...
This Tunable Macro Strategy uses StackSats' output as the **_preference weight_** and dynamically boosts or dampens it based on the broader global economy's performance.
...
For the **training period (2018–2023)**, the External Tunable approach achieved an SPD of **8,210.91**, compared with **8,418.79** for Uniform DCA, corresponding to a **2.47%** underperformance.

For the **test period (2024–2025)**, the External Tunable approach achieved an SPD of **1,346.27**, compared with **1,292.12** for Uniform DCA, representing a **4.19%** improvement.
